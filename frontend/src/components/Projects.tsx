...
const Projects = () => {
    return (
        <div className="flex flex-col justify-center items-center text-center text-[#EBEBEB] mt-8">
            ...
            <div className="border-1 border-[#2E2E2E] rounded-xl mx-3 py-4 hover:border-[#7B9EFF]/50 transition-all duration-300">
                <img src="./projects-photos/clothing_img.jpg" alt="Project Image" className="w-full h-42" />

                <div className="my-10 ml-3">
                    <h2 className="text-left text-xl">Loja de Roupas FullStack</h2>

                    <p className="text-left text-[#8C8C8C] my-3">Este projeto é uma loja de roupas que permite aos usuários comprar e pagar por suas compras. Para usar os recursos de administração, use a seguinte conta: email: 'admin@gmail.com', senha: '12345'. Para o frontend utilizei React e o backend foi feito em Node.js. O pagamento é feito através do MercadoPago.</p>
            ...
            <div className="border-1 border-[#2E2E2E] rounded-xl mx-3 py-4 hover:border-[#7B9EFF]/50 transition-all duration-300">
                <img src="./projects-photos/countdown_img.jpg" alt="Project Image" className="w-full h-42" />

                <div className="my-10 ml-3">
                    <h2 className="text-left text-xl">Contagem Regressiva com TypeScript</h2>

                    <p className="text-left text-[#8C8C8C] my-3">Este projeto é um aplicativo de contagem regressiva que permite aos usuários criar páginas personalizadas e compartilhar com seus amigos. Dentro desta página você pode criar eventos e escolher uma música do Spotify para personalizar sua página. Para o frontend utilizei React e o Backend foi feito em Node.js com TypeScript.</p>
            ...
            <div className="border-1 border-[#2E2E2E] rounded-xl mx-3 py-4 hover:border-[#7B9EFF]/50 transition-all duration-300">
                ...
                <div className="my-10 ml-3">
                    ...
                    <p className="text-left text-[#8C8C8C] my-3">Lista 'To-do' feita utilizando Python. A interface grafica foi feita utilizando a biblioteca 'PyQT' e o salvamento dos dados foi feito utilizando o 'Pandas' em um arquivo 'csv'. A lista 'To-do' facilita a programação de tarefas cotidianas.</p>
